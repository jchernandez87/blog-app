...
RSpec.describe Comment, type: :model do
  it 'Should update post comments_counter value' do
    user = User.create(name: 'Joe', photo: 'url', bio: 'teacher from germany', posts_counter: 1)
    post = Post.create(author_id: user.id, title: 'New Post', text: 'post text', comments_counter: 0, likes_counter: 1)
